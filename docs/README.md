...
|---|---|---|
| [Hub protocol v0.6](hub-protocol-v0.6.md) | Current experimental release | Signed problem registry, task repositories, provisioning, migration, and live projection |
